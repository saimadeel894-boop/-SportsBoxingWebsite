  ...
  return (
    <>
      <style>{`
        ...
        .hero-customers { position: absolute; top: 8%; right: 5%; z-index: 5; font-family: 'Bebas Neue', sans-serif; font-size: 2.2rem; font-weight: 900; color: #000; letter-spacing: 0.05em; margin: 0; will-change: transform; white-space: nowrap; }
        .hero-jerseys { position: absolute; top: 18%; right: 4%; width: 185px; z-index: 5; }
