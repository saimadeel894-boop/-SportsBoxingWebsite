const FloatingWhatsApp = () => {
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-[9999] flex items-center gap-2.5 group"
    >
      <div className="w-12 h-12 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform" style={{ background: "#25D366" }}>
